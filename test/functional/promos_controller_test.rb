...
class PromosControllerTest < ActionController::TestCase
  ...
  test "should create promo" do
    assert_difference('Promo.count') do
      post :create, promo: { amount: @promo.amount, available: @promo.available, code: @promo.code, expires: @promo.expires }
    end
  ...
  test "should update promo" do
    put :update, id: @promo, promo: { amount: @promo.amount, available: @promo.available, code: @promo.code, expires: @promo.expires }
    assert_redirected_to promo_path(assigns(:promo))
  end
